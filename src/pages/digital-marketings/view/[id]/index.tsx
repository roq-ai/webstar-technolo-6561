...
import { getDigitalMarketingById } from 'apiSdk/digital-marketings';
import { DigitalMarketingInterface } from 'interfaces/digital-marketing';

function DigitalMarketingViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Digital Marketing Details',
              isCurrent: true,
            },
          ]}
        />
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Seo" text={data?.seo} />

                <FormListItem label="Sem" text={data?.sem} />

                <FormListItem label="Ppc Campaigns" text={data?.ppc_campaigns} />

                <FormListItem label="Smm" text={data?.smm} />
