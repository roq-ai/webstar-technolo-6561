...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Webstar Technologies`}</title>

        <meta
          name="description"
          content="Webstar Technologies: Your Beacon in the Digital Realm. Transforming Businesses into Digital Powerhouses, Guiding Your Brand's Journey to Success. Choose Us to Fuel Your Future."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956602868-6ae368943878?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxkaWdpdGFsJTIwbWFya2V0aW5nfGVufDB8fHx8MTY5MDI2MjU2OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Webstar Technologies: Your Beacon in the Digital Realm. Transforming Businesses into Digital Powerhouses, Guiding Your Brand's Journey to Success. Choose Us to Fuel Your Future.`}
            </Text>
            <Box
