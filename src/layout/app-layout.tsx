...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'graphic-designer', 'digital-marketer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Digital Marketings',
      path: '/digital-marketings',
      entity: 'digital_marketing',
      service: AccessServiceEnum.PROJECT,
      icon: FiBarChart2,
    },
    { name: 'Visuals', path: '/visuals', entity: 'visual', service: AccessServiceEnum.PROJECT, icon: FiImage },
